...
public class FetchModel : PageModel
{
    ...
    private async Task<IActionResult?> TryProxyAzureBlobWithSasAsync(string url, MyDigitalLibrary.Core.Models.Book book)
    {
    ...
    private async Task<IActionResult> ProxyRemoteUrlAsync(string url, MyDigitalLibrary.Core.Models.Book book)
    {
        try
        {
            using var httpClient = new System.Net.Http.HttpClient();
